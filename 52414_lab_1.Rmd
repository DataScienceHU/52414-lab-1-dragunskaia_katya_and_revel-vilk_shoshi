...
library(tidyverse)
datasets.pipe = list(cases.agg.pipe = data_con, death.agg.pipe = data_death, recover.agg.pipe = data_rec)
...
proof= all_equal(agg, agg.pipe)
print(paste='The values are similar. the only diffence in the name', proof)
