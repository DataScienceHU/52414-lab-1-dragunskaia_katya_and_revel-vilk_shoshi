...
cases.t = t(cases)
{cases.plot = barplot(cases.t[1,], xlab = "Countries", ylab = "Corona cases", main = "The top 10 countries of confirmed cases in 31.March.2020", col = c("red"), legend = rownames(cases.t[1,]))
others.plot = barplot(cases.t[2:3,], xlab = "Countries", ylab = "Corona cases", main = "The top 10 countries of confirmed cases in 2020-03-31", col = c("dark blue", "green"), legend = rownames(cases.t[2:3,]), add = T)}
...
{x= barplot(top.diff.cases$diff.cases, names.arg = top.diff.cases$Date, main= 'Top 10  country & date combinations with the greatest new daily Corona cases', ylab= 'Absolute difference', las=2,  cex.axis = 0.75, cex.names= 0.75, col= rainbow(10))
text(x, 0 ,top.diff.cases$Country.Region, cex=1, pos=3, col='black')
}
print(top.diff.death)
{y= barplot(top.diff.death$diff.death, names.arg = top.diff.death$Date, main= 'Top 10  country & date combinations with the greatest new daily Corona death', ylab= 'Absolute difference', las=2, cex.axis = 0.75, cex.names= 0.75, col= rainbow(10))
