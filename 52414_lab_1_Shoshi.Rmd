...
par(new=TRUE)
plot(corona_eco_plot$pop65, corona_eco_plot$norm_deaths, pch= 1,  xlim=c(min(corona_eco_plot$pop65), max(corona_eco_plot$pop65)+5), axes=F, xlab="", ylab="", col = ifelse(corona_eco_plot$norm_deaths > 15 | corona_eco_plot$pop65 > 24, "red", "black"))
axis(4)
