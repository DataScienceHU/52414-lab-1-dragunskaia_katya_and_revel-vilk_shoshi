...
YOUR SOLUTION HERE.
# Research question: Is the risk of death from Corona is related to the health expenditure per capita (current US$). Data is taken from the world bank, updated for 2017 (no 2018 or 2019 exists). 
...
plot(x= Q5$risk, y= Q5$logCHE, main= "Corona deaths and health expendure", xlab = "Risk of death from Corona", ylab = "Health expendure per capita", abline(lm_CHE, col = "red"))
print("Increased health expendure per capita in 2017 was not associated with lower risk of death from Corona ")
